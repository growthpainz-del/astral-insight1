            ...
            <div className={cn("max-w-[85%]", isUser && "flex flex-col items-end")}>
                {message.content && (
                    <div className={cn(
                        ...
                        isUser ? "bg-purple-600 text-white" : "bg-slate-800/80 border border-slate-700/50 text-slate-200"
                    )}>
                        {isUser ? (
                                ...
                                components={{
                                    code: ({ inline, className, children, ...props }) => {
                                        ...
                                        return !inline && match ? (
                                            ...
                                            <code className="px-1.5 py-0.5 rounded bg-slate-900 text-purple-300 text-xs font-mono">
                                                {children}
                                            </code>
                                        );
                                    },
                                    a: ({ children, ...props }) => (
                                        <a {...props} className="text-purple-400 hover:text-purple-300 underline" target="_blank" rel="noopener noreferrer">{children}</a>
                                    ),
                                    p: ({ children }) => <p className="my-1.5 leading-relaxed">{children}</p>,
                                    ul: ({ children }) => <ul className="my-1.5 ml-4 list-disc marker:text-purple-500">{children}</ul>,
                                    ol: ({ children }) => <ol className="my-1.5 ml-4 list-decimal marker:text-purple-500">{children}</ol>,
                                    ...
                                    blockquote: ({ children }) => (
                                        <blockquote className="border-l-2 border-purple-500 pl-3 my-2 text-slate-400 italic">
                                            {children}
                                        </blockquote>
                                    ),
                                }}
