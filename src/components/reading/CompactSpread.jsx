...
export const SYSTEM_SPREADS = [
  ...
  },
  {
    ...
    cardSizeW: 26,
    positions: [
      { name: "Root",      meaning: "What has shaped this situation",    cx: 16.6, cy: 50 },
      { name: "Now",       meaning: "The energy present in this moment", cx: 50,   cy: 50 },
      { name: "Emergence", meaning: "What is being called forward",      cx: 83.4, cy: 50 },
    ]
  },
  {
    id: "business_diamond",
    ...
    cardSizeW: 24,
    positions: [
      { name: "Foundation",  meaning: "What your business is built on", cx: 50,   cy: 18 },
      { name: "Challenge",   meaning: "What is blocking growth",        cx: 16.6, cy: 50 },
      { name: "Core",        meaning: "The heart of your vision",       cx: 50,   cy: 50 },
      { name: "Opportunity", meaning: "What wants to emerge",           cx: 83.4, cy: 50 },
      { name: "Outcome",     meaning: "Where this path leads",          cx: 50,   cy: 82 },
    ]
  },
  {
    id: "path_forward",
    ...
    cardSizeW: 20,
    positions: [
      { name: "Where You Stand", meaning: "Your current position",              cx: 12.5, cy: 50 },
      { name: "What to Release", meaning: "What is holding you back",           cx: 33.3, cy: 28 },
      { name: "Hidden Strength", meaning: "What you're not seeing in yourself", cx: 33.3, cy: 72 },
      { name: "The Next Step",   meaning: "The immediate action",               cx: 50,   cy: 50 },
      { name: "The Obstacle",    meaning: "What will test you",                 cx: 66.7, cy: 28 },
      { name: "The Ally",        meaning: "What or who supports you",           cx: 66.7, cy: 72 },
      { name: "The Destination", meaning: "Where this path leads",              cx: 87.5, cy: 50 },
    ]
  },
  {
    id: "twin_flames",
    ...
    cardSizeW: 24,
    positions: [
      { name: "Your Flame",  meaning: "Your current energy",                cx: 26.3, cy: 18 },
      { name: "Their Flame", meaning: "Their current energy",               cx: 73.7, cy: 18 },
      { name: "The Mirror",  meaning: "What you reflect in each other",     cx: 50,   cy: 42 },
      { name: "The Shadow",  meaning: "What is unresolved between you",     cx: 50,   cy: 58 },
      { name: "The Wound",   meaning: "What is asking to be healed",        cx: 26.3, cy: 82 },
      { name: "The Union",   meaning: "The potential of this connection",   cx: 73.7, cy: 82 },
    ]
  },
  {
    id: "crescent_moon",
    ...
    cardSizeW: 20,
    positions: [
      { name: "The Dark",    meaning: "What lives in your shadow right now",     cx: 22, cy: 82 },
      { name: "The Turning", meaning: "What is beginning to shift",              cx: 11, cy: 62 },
      { name: "The Sliver",  meaning: "The first light of new awareness",        cx: 18, cy: 40 },
      { name: "The Heart",   meaning: "What you are growing toward",             cx: 38, cy: 22 },
      { name: "The Glow",    meaning: "Your emerging strength",                  cx: 62, cy: 28 },
      { name: "The Pull",    meaning: "What the moon is calling you to release", cx: 78, cy: 48 },
      { name: "The Promise", meaning: "What is being born in you",               cx: 80, cy: 70 },
    ]
  },
  {
    id: "seven_sisters",
    ...
    cardSizeW: 20,
    positions: [
      { name: "Alcyone", meaning: "The calm at the center — your core truth",      cx: 50,   cy: 46 },
      { name: "Maia",    meaning: "The nurturer — what needs tending",             cx: 24,   cy: 26 },
      { name: "Electra", meaning: "The spark — where your power lives",            cx: 76,   cy: 24 },
      { name: "Taygete", meaning: "The chase — what you are pursuing",             cx: 14,   cy: 50 },
      { name: "Celaeno", meaning: "The veil — what is hidden from you",            cx: 86,   cy: 50 },
      { name: "Sterope", meaning: "The flame — your creative fire",                cx: 26,   cy: 74 },
      { name: "Merope",  meaning: "The whisper — the quiet wisdom you're missing", cx: 74,   cy: 74 },
    ]
  },
  {
    id: "celtic_cross",
    ...
    cardSizeW: 17,
    positions: [
      { name: "The Present",    meaning: "What surrounds you now",         cx: 33.3, cy: 42 },
      { name: "The Cross",      meaning: "What challenges or supports you", cx: 33.3, cy: 42, rotation: 90 },
      { name: "The Crown",      meaning: "What you aspire to",             cx: 33.3, cy: 22 },
      { name: "The Root",       meaning: "What grounds this situation",    cx: 33.3, cy: 62 },
      { name: "The Past",       meaning: "What is passing away",           cx: 13,   cy: 42 },
      { name: "The Future",     meaning: "What is approaching",            cx: 53.6, cy: 42 },
      { name: "Your Power",     meaning: "How you see yourself",           cx: 83.4, cy: 82 },
      { name: "Outside Forces", meaning: "How others see you",             cx: 83.4, cy: 62 },
      { name: "Hopes & Fears",  meaning: "What you hold inside",           cx: 83.4, cy: 42 },
      { name: "The Outcome",    meaning: "Where this is heading",          cx: 83.4, cy: 22 },
    ]
  },
];
        ...
        {card && !isRevealed && (
          <>
            <button
              ...
              className="rounded-xl overflow-hidden shadow-lg border-2 border-amber-400/25 hover:border-amber-400/55 hover:scale-105 active:scale-95 transition-all"
              style={{ width: cardW, height: cardH, transform: `rotate(${rotation}deg)` }}
            >
              {deck?.back_image_url ? (
        ...
        {card && isRevealed && (
          <>
            <motion.button
              ...
              className="rounded-xl overflow-hidden shadow-xl border-2 border-amber-400/45 hover:border-amber-400/75 hover:scale-105 active:scale-95 transition-all"
              style={{ width: cardW, height: cardH, transform: `rotate(${rotation}deg)` }}
            >
              {card.image_url ? (
                <img
    ...
    <div className="w-full flex flex-col items-center px-4">
      ...
      <div
        ...
        style={{
          ...
          boxShadow:  "0 0 40px rgba(100,50,200,0.08) inset",
        }}
      >
        {/* Grid overlay */}
        <svg
