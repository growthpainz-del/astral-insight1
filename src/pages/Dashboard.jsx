...
export default function Dashboard() {
  ...
  const handleRetry = () => {
    setIsRetrying(true);
    setError("");
    // Reset user state — triggers the useEffect chain without a full page reload
  ...
  const handleDownloadManuals = async (zip = false) => {
    try {
      ...
      toast.error('Failed to export manuals. Please try again.');
    }
  };
  ...
  return (
    <PullToRefresh onRefresh={() => setCurrentUser(undefined)}>
