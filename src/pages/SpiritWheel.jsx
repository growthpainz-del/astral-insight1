...
const WHEEL_DATA = {
  outer: outerIds.map(id => {
    const special = {
      ...
      "1": { general: "Independence of others, a leader" },
      "4": { general: "Structure, building, Security: Idea is stable, solid" },
      "7": { general: "Insight/Turning point: a new learning point will happen" },
      "0": { general: "Zero has no meaning, just a number" },
    };
    return { id, general: `Mystery of ${id}`, ...(special[id] || {}) };
  }),
  middle: [
    { id: "🚪", meaning: "Option closed. This path is shut for now." },
    { id: "♫", meaning: "Music Note — Creative flow & harmony. Let ideas sing." },
    ...
    ...Array.from({length: 13}).map((_, i) => ({ id: `M${i}`, meaning: "Unknown depth" }))
  ],
  inner: [
    { id: "↑", meaning: "Go / Yes / Forward / Full speed ahead" },
    { id: "?", meaning: "What? — Clarify the question. More info needed." },
    { id: "😊", meaning: "Hi!!! I'm here." },
