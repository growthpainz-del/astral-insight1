...
Deno.serve(async (req) => {
  try {
    ...
    // Allow either authenticated Admin/Pro OR shared-secret header for function tester/automation
    let user = null;
    ...
    const hasSharedAccess = !!sharedSecret && secretHeader === sharedSecret;
